...
class PropostaController extends Controller
{
    ...
    #[OA\Get(path: '/api/v1/propostas/{proposta}', summary: 'Exibe uma proposta', tags: ['Propostas'], parameters: [new OA\Parameter(name: 'proposta', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))], responses: [new OA\Response(response: 200, description: 'Dados da proposta', content: new OA\JsonContent(ref: '#/components/schemas/PropostaResource')), new OA\Response(response: 404, description: 'Não encontrada')])]
    ...
    #[OA\Post(path: '/api/v1/propostas/{proposta}/approve', summary: 'SUBMITTED → APPROVED', tags: ['Propostas'], parameters: [new OA\Parameter(name: 'proposta', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))], responses: [new OA\Response(response: 200, description: 'Proposta aprovada', content: new OA\JsonContent(ref: '#/components/schemas/PropostaResource')), new OA\Response(response: 422, description: 'Transição inválida', content: new OA\JsonContent(ref: '#/components/schemas/ErrorBusiness'))])]
    ...
    #[OA\Post(path: '/api/v1/propostas/{proposta}/reject', summary: 'SUBMITTED → REJECTED', tags: ['Propostas'], parameters: [new OA\Parameter(name: 'proposta', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))], responses: [new OA\Response(response: 200, description: 'Proposta rejeitada', content: new OA\JsonContent(ref: '#/components/schemas/PropostaResource')), new OA\Response(response: 422, description: 'Transição inválida', content: new OA\JsonContent(ref: '#/components/schemas/ErrorBusiness'))])]
    ...
    #[OA\Post(path: '/api/v1/propostas/{proposta}/cancel', summary: 'DRAFT|SUBMITTED → CANCELED', tags: ['Propostas'], parameters: [new OA\Parameter(name: 'proposta', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))], responses: [new OA\Response(response: 200, description: 'Proposta cancelada', content: new OA\JsonContent(ref: '#/components/schemas/PropostaResource')), new OA\Response(response: 422, description: 'Transição inválida', content: new OA\JsonContent(ref: '#/components/schemas/ErrorBusiness'))])]
